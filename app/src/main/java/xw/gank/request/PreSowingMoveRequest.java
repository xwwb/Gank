...
public class PreSowingMoveRequest extends BaseRequest {
    
    public void requestBestData (Activity activity,String start,final RequestListern listen){
     String url=UrlBase+"/coming_soon?"+"start="+start;
        Log.i("====url",""+url);
