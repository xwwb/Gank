...
public class SearchMoveRequest extends BaseRequest {
    
    public void requestBestData (Activity activity,String q,String start,final RequestListern listen){
     String url=UrlBase+"/search?"+"q="+q+"&start="+start;
        Log.i("====url",""+url);
